    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('contacts/modify') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{$errors->has('date_of_birth') ? ' is-invalid':''}}" id="date_of_birth" value="{{ old('date_of_birth', date('d/m/Y', strtotime($contact->date_of_birth))) }}" name="date_of_birth" placeholder="00/00/0000">
